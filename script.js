...
setaLeft.addEventListener('click', () =>{ //quando clicar
tenis1.style.left = '650px'
tenis2.style.left = '-50px' //acontece isso

})
setaRight.addEventListener('click', () =>{ //quando clicar
tenis1.style.left = '-50px'
tenis2.style.left = '-650px'//acontece isso
})
